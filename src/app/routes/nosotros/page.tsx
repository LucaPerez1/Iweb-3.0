...
function NosotrosPage() {
    ...
    return (
        <main>
            ...
            <section className="aboutContainer">
                <div className="about pb-60 md:pb-20 md:pb-0 px-4 md:px-10 pt-8 md:pt-14">
                    <div className=" w-[100%] md:w-[50%] flex flex-col items-center md:items-start">
                        ...
                        <p className="pb-4 md:pb-8">{t('firstTextAboutUs')}</p>
            ...
            <section>
                <h2 className="seccionTitle my-10 md:my-16">{t('processSectionTitle')}</h2>
            ...
            <section className="mx-4 md:mx-10 my-10 md:my-14">
                <div className="grid grid-rows-3 md:grid-cols-2 md:grid-rows-2 gap-y-7 gap-x-6 md:gap-x-16 mb-10 md:mb-14">
                    ...
                    <div className="workFlowImgContainer row-span-2 col-span-1">
                        <img src="/img/metodo-image.jpg" alt={t('workFlowImageAlt')} className=" w-[90%] md:w-[100%]" />
                    </div>
                    ...
                    <div className="stepContainer flex row-span-1 col-span-1 pt-12">
                        <div className="step">
                            ...
                            <p className="stepName">{t('stepConsultaion')}</p>
                        </div>

                        <div className="step">
                            <Reunion />
                            <div className="stepCircle"></div>
                            <p className="stepName">{t('stepMeeting')}</p>
                        </div>

                        <div className="step">
                            <Analisis />
                            <div className="stepCircle"></div>
                            <p className="stepName">{t('stepAnalysis')}</p>
                        </div>
                ...
                <div className="stepContainer hidden md:flex">
                    <div className="step">
                        <DiseñoDelPlan />
                        <div className="stepCircle"></div>
                        <p className="stepName">{t('stepPlanDesign')}</p>
                    </div>

                    <div className="step">
                        <Desarrollo />
                        <div className="stepCircle"></div>
                        <p className="stepName">{t('stepDevelopment')}</p>
                    </div>

                    <div className="step">
                        <Propuesta />
                        <div className="stepCircle"></div>
                        <p className="stepName">{t('stepProposals')}</p>
                    </div>

                    <div className="step">
                        <RevisionDeFeedback />
                        <div className="stepCircle"></div>
                        <p className="stepName">{t('stepFeedback')}</p>
                    </div>

                    <div className="step">
                        <EntregaFinal />
                        <div className="stepCircle"></div>
                        <p className="stepName">{t('stepFinal')}</p>
                    </div>
