			...
			<main>
				<section className="relative w-full h-screen overflow-hidden">
					...
					<div className="absolute inset-0 flex flex-col justify-center px-6 md:px-16 text-white">
						<div className="w-full md:w-1/2 text-center md:text-left items-center md:items-start flex flex-col gap-6">
							<h1 className="titleVideo text-[2.2rem]">
								{t('titleVideo')} 
							</h1>
							<p className="textVideo text-[1rem]">
								{t('textVideo')} 
							</p>
							<Link href={'/contacto'} className="btnVideo px-6 py-3 bg-[#08E6F5] bg-opacity-20 backdrop-blur-md border border-[#08E6F5] text-[#f3f3f3] rounded-lg hover:bg-[#08E6F5] hover:text-[#191919] transition">{t('btnVideo')} </Link>
